...
.PHONY: check help install install-dev install-no-deps uninstall clean format format-check lint typecheck test test-verbose coverage run
...
run: install  ## Run the personal assistant GUI
