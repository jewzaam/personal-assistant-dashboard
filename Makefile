...
.PHONY: check help install install-dev install-meetings install-no-deps uninstall clean format format-check lint typecheck test test-verbose coverage mutation mutation-report run
...
run: install-dev install-meetings  ## Run the personal assistant GUI
	...
	$(PYTHON) -m personal_assistant --debug gui --log-file $(LOG_FILE)
